import '../index.css';
import love from '../assets/Pilu.jpg'
function Pilu() {
    return (
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="text-white text-center max-w-md font-mono">
            <p>
          OMG Hii. I love you so so much. How do I even express my love?? 
          </p>
          <h1 className="text-4xl font-bold mt-4">
            I could shout it out
          </h1>
          <p>
            but real love isn't (always) loud. It's in the quiet moments, the shared smiles, the comfort of just being together. I love you more than words can say, more than any grand gesture could show. I love you when you wrap yourself up in a little blankie, or when you dress up in cute tops and look oh so so adorable.
